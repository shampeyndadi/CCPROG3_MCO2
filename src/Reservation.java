...
public class Reservation {
    ...
    private String getDetailedPriceBreakdown(){
        ...
        if (discounted){
            double computed = pricePerNight * numberOfNights; // to be fixed, this will change once price modifiers are taken into account
            return breakdown + "TOTAL COMPUTED PRICE: " + computed + "\n" + "DISCOUNT CODE APPLIED\n";
        }
