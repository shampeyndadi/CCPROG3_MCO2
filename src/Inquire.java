...
/**
 * Inquire is a JPanel that provides the user interface for inquiring about hotel details.
 * It displays basic hotel information, room availability, room details, and reservation details.
 */
public class Inquire extends JPanel {
    ...
    /**
     * Constructs a new Inquire panel for the specified hotel.
     *
    ...
    /**
     * Displays the information of the selected room and its available dates.
     *
     * @param room the Room object whose details are to be displayed
     * @param availableDates the list of available dates for the selected room
     */
    ...
    /**
     * Sets the confirmation message in the confirmation text area.
     *
    ...
    /**
     * Gets the name of the selected room from the combo box.
     *
     * @return the name of the selected room as a String
     */
    ...
    /**
     * Gets the name of the selected reservation from the combo box.
     *
     * @return the name of the selected reservation as a String
     */
    ...
    /**
     * Sets an ActionListener for the room combo box items.
     *
    ...
    /**
     * Sets an ActionListener for the reservation combo box items.
     *
     * @param listener the ActionListener to be set
     */
    ...
    /**
     * Sets the room information labels for available rooms and total booked rooms.
     *
     * @param availableRooms the number of available rooms
     * @param totalBookedRooms the number of total booked rooms
     */
    ...
    /**
     * Clears the text fields for check-in and check-out days.
     */
    ...
    /**
     * Gets the check-in day entered by the user.
     *
    ...
    /**
     * Gets the check-out day entered by the user.
     *
