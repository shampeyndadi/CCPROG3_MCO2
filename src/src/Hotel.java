...
public class Hotel {
    ...
    public int roomsOnDate(Date checkIn, Date checkOut) {
        ...
        ArrayList<Room> countedRooms = new ArrayList<>();
        ...
        for (Reservation reservation : reservations) {
            ...
            if (!(checkOut.before(reservationCheckIn) || checkIn.after(reservationCheckOut))) {
                ...
                if (!countedRooms.contains(room)) {
                    bookedRooms++;
                    countedRooms.add(room);
                }
            }
        }
     ...
     * @return true if the hotel is fully booked for all days in the month, false otherwise.
     */
    public boolean isFullyBookedForMonth() {
        ArrayList<Room> allRooms = viewRooms();
        ArrayList<Reservation> allReservations = viewReservations();
