...
public class Reservation {
    ...
    /**
     * Retrieves the total computed price of the reservation.
    ...
    /**
     * Retrieves the total price of the reservation with discount or not.
     *
    ...
    /**
     * Applies a discount code to the reservation if the code is valid and not previously used.
     *
     * @param discountCode The discount code to apply.
     * @return A message indicating the result of the discount application.
     */
    public String applyDiscount(String discountCode) {
        ...
        if (!discounted) {
            ...
            switch (discountCode) {
                ...
                case "STAY4_GET1":
                    if (numberOfNights >= 5) {
                        double[] modifier = room.getModifiers();
                        newPrice -= pricePerNight * modifier[0];
                        setTotalPrice(newPrice);
                        codeValid = true;
                        discounted = true;
